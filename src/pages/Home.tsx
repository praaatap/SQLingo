        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pt-20 pb-32 sm:py-20 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center gap-4 lg:justify-start justify-center">
              ...
              <Link to="/problems/1" className="w-full sm:w-auto">
                <Button
                  variant="outline"
                  size="lg"
                  className="w-full sm:w-auto gap-2 h-14 text-base bg-transparent text-white border-white/10 hover:bg-white/3 hover:border-white/20"
                >
        ...
        <FadeIn className="w-full"><div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li>
                  <Link to="/problems?difficulty=Easy" className="text-muted-foreground hover:text-primary transition-colors flex items-center gap-2">
                    <span className="w-2 h-2 rounded-full bg-emerald-500" />
                    Easy Problems
                  </Link>
                </li>
                <li>
                  <Link to="/problems?difficulty=Medium" className="text-muted-foreground hover:text-primary transition-colors flex items-center gap-2">
                    <span className="w-2 h-2 rounded-full bg-amber-500" />
                    Medium Problems
                  </Link>
                </li>
                <li>
                  <Link to="/problems?difficulty=Hard" className="text-muted-foreground hover:text-primary transition-colors flex items-center gap-2">
          ...
          <div className="pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              <Link to="https://github.com" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
                <Github className="h-5 w-5" />
              </Link>
              <Link to="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
